...
//public class Main{
//	
//	public static void main(String[] args) throws Vacio{
//		ArrayList<Productos> catalogo = new ArrayList<>();
//		
//		catalogo.add(new Altavoz("Sarandonga", "Amazon", 100, "Alexa"));
//		catalogo.add(new Luces("Donson", "Aliexpre", 20, "blanco"));
//		catalogo.add(new Termostato("Termoplex", "MSI", 45, 20));
//		catalogo.add(new Camara("Dyson", "Amaxon", 2000, 4000));
//		
//		
//		// 3. Recorremos el catálogo
//				for (Productos producto : catalogo) {
//					
//					// Primero, encendemos el dispositivo para que pueda operar
//					producto.encender();
//					
//					// Envolvemos las acciones en un try-catch por si salta la excepción
//					try {
//						
//						// Escáner de identidad: ¿Es un Altavoz?
//						if (producto instanceof Altavoz) {
//							// Lo transformamos (cast) para poder usar sus métodos
//							Altavoz altavoz = (Altavoz) producto; 
//							altavoz.subirNivel();
//							altavoz.subirNivel(); // Subimos dos veces
//							System.out.println("🤖 Asistente del altavoz: " + altavoz.getNombreAsistente());
//						} 
//						// ¿O es una Luz?
//						else if (producto instanceof Luces) {
//							Luces luz = (Luces) producto;
//							luz.subirNivel();
//							luz.setColor("Rojo Alarma"); // Cambiamos el color
//						} 
//						// ¿O es un Termostato?
//						else if (producto instanceof Termostato) {
//							Termostato termo = (Termostato) producto;
//							termo.cambiarFuncion();
//							termo.activarAlerta("⚠️ Aviso: Temperatura irregular");
//						} 
//						// ¿O es una Cámara?
//						else if (producto instanceof Camara) {
//							Camara cam = (Camara) producto;
//							cam.iniciarGrabacion();
//							cam.activarAlerta("🚨 Aviso: Movimiento detectado");
//						}
//
//						// Imprimimos el estado final del soldado tras las maniobras
//						System.out.println(producto); // No hace falta poner .toString(), Java lo hace solo
//						System.out.println("--------------------------------------------------");
//
//					} catch (DispositivoApagadoException e) {
//						// Si por algún motivo estaba apagado, la granada explota aquí
//						System.out.println("Error en la maniobra: " + e.getMessage());
//					}
//				}
//		
//	}
